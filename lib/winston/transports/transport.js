...
Transport.prototype.normalizeQuery = function (options) {
  ...
  if (typeof context.from !== 'object') {
    context.from = new Date(context.from);
  }

  // now
  options.until = options.until || new Date;
  if (typeof context.until !== 'object') {
    context.until = new Date(context.until);
  }
...
//
Transport.prototype.stream = function (options) {
  return;
};
