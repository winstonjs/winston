...
// #### @labels {Object} **Optional** Array of labels to attach
...
//
Transport.prototype.logException = function (msg, meta, labels, callback) {
  var self = this;
  ...
  this.log('error', msg, meta, labels, function () { });
};
