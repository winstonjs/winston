...
// #### @msg {string} Message to log
// #### @meta {Object} **Optional** Additional metadata to attach
// Formats the specified `msg` under `level`, optionally with `meta`. Calls
// common.log() by default.
// Subclasses can override this method, and users can set the 'formatter'
// option of their Transport instance.
Transport.prototype.formatMessage = function(level, msg, meta) {
  if (this.formatter) {
    return this.formatter(level, msg, meta);
  }
  else {
    return common.log({
