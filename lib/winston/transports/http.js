...
module.exports = class Http extends TransportStream {
  ...
  log(info, callback) {
    ...
    this.callIndex = this.callIndex === Number.MAX_SAFE_INTEGER ? 0 : this.callIndex + 1;
    this.callsInProgress.set(
        ...
        (async () => {
            ...
            this.callsInProgress.delete(index);
        })()
    );
  ...
  /**
   * Flush the transport.
   * @returns {Promise<void[]>} - A promise that completes when all active http calls are complete.
   */
  flush() {
