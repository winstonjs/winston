...
var DailyRotateFile = exports.DailyRotateFile = function (options) {
  ...
  this.getFileExt = function() {
    var ext = this._basename.split('.').pop();
    return ext ? '.' + ext : '.log';
  };
};
...
DailyRotateFile.prototype.query = function (options, callback) {
  ...
  var file = path.join(this.dirname, this._basename + this.getFormattedDate() + this.getFileExt()),
...
DailyRotateFile.prototype._getFile = function (inc) {
  var self = this,
      filename = this._basename + this.getFormattedDate() + this.getFileExt(),
      remaining;
