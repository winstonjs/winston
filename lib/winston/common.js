...
//
// ### bool environmentIsBrowser
// a boolean indicating whether or not winston is being run in the browser.
//
exports.environmentIsBrowser = !(typeof module !== 'undefined' && module.exports);
...
if (!exports.environmentIsBrowser) {
    var fs = require('fs');
}
