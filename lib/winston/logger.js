...
var stream = require('stream'),
    ...
    formatRegExp = common.formatRegExp;
...
Logger.prototype.log = function (level, msg, meta) {
  ...
  var interpolate = msg && msg.match && msg.match(formatRegExp),
      fmtCount = (interpolate && interpolate.length) || 0;

  if (fmtCount) {
    //
    // TODO: Check to see if (arguments.length - 1) > fmtCount and
    // assign the splat arguments accordingly. String interpolation must
    // be done at this point in the objectMode stream since we only ever
