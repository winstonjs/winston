  ...
  ['log', 'profile'].concat(Object.keys(this.levels)).forEach(function (method) {
    target[method] = function () {
      ...
      if (self.saveStackTrace && self.stripInternalFrames) {
        ...
        if (typeof meta === 'object' && typeof meta.stack !== 'function') {
          meta.stack = arguments.callee;
        } else {
          args.push({ stack: arguments.callee });
        }
...
Logger.prototype.log = function (level, msg) {
  ...
  if (this.saveStackTrace) {
    var caller = typeof meta.stack === 'function' && meta.stack || arguments.callee.caller;
    Error.captureStackTrace(meta, caller);
  }
