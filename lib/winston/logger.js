...
class Logger extends Transform {
  ...
  child(defaultMetaOverride) {
    const logger = this;
    return Object.create(logger, {
      _addDefaultMetaAndWrite: {
        value: function (info) {
          if (!defaultMetaOverride) {
            return logger._addDefaultMetaAndWrite(info);
          }
  ...
  log(level, msg, ...splat) {
    ...
    if (arguments.length === 1) {
      ...
      this._addDefaultMetaAndWrite(level);
      return this;
    }
    ...
    if (arguments.length === 2) {
      if (msg && typeof msg === 'object') {
        ...
        this._addDefaultMetaAndWrite(msg);
        return this;
      }
    ...
    if (typeof meta === 'object' && meta !== null) {
      ...
      if (!tokens) {
        ...
        this._addDefaultMetaAndWrite(info);
        return this;
      }
    }
