...
Logger.prototype.log = function (level, msg) {
  ...
  if (this.transport.length === 0) return callback(new Error('Cannot log with no transports.'));
  else if (!levels[leve]) return callback(new Error('Unknown log level: ' + level));
