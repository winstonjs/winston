...
var Logger = exports.Logger = function (options) {
  ...
  this.withContext = function withContext(context) {
    var that = this, logger = new Logger(options), prop, descriptor;
...
//
// function pop ()
//   Removes last context from the stack.
//
