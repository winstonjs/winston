...
class Logger extends Transform {
  ...
  child(childMetadata) {
    ...
    return Object.create(logger, {
      _addDefaultMeta: {
        value: function (msg) {
          if (this.defaultMeta) {
            return Object.assign(msg, this.defaultMeta, childMetadata);
          }
          return Object.assign(msg, childMetadata);
        }
      }
    });
  }
  ...
  log(level, msg, ...splat) {
    ...
    if (typeof meta === 'object' && meta !== null) {
      ...
      if (!tokens) {
        const infoObj = { message: msg };
        const info = Object.assign({}, this._addDefaultMeta(infoObj), meta, {
          [LEVEL]: level,
          [SPLAT]: splat,
          level,
          message: msg
