...
Logger.prototype.log = function log(level, msg, meta) {
  ...
  if (tokens) {
    this._splat({ level, message: msg }, tokens, Array.prototype.slice.call(arguments, 2));
    return this;
  }

  const info = Object.assign({}, meta, { level, message: msg });
  this.write(info);
  return this;
};
