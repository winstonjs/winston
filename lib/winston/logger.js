...
//
// function profile (id, [msg, callback])
...
//
Logger.prototype.profile = function (id, msg, callback) {
  ...
  if (this.profilers[id]) {
    ...
    // If there are only two arguments to profile
    // assume that msg should be id
