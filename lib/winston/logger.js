...
Logger.prototype.add = function (transport, options, created) {
  ...
  //Want to allow multiple transports of same type for different log levels
  else if ( (instance.name !== 'file' || instance.name !== 'dailyRotateFile') && this.transports[instance.name]) {
