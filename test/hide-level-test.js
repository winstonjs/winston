...
function assertHideLevel (basename, options) {
  ...
  return {
    ...
    "should log with the appropriate hideLevel": function (_, filename) {
...
vows.describe('winston/transport/hideLevel').addBatch({
  "When hideLevel option is used": {
    "with file transport": {
      "with value set to false": assertHideLevel('withLevel', {
        pattern: /^info:\s/,
        json: false,
        timestamp: false,
        hideLevel: false
      }),
      "with value set to true ": assertHideLevel('withoutLevel', {
        pattern: /^When a/,
        json: false,
        timestamp: false,
        hideLevel: true
